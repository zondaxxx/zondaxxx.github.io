...
Варианты: оружие knife/ak/phone/none, маска classic/bloody/dark, балахон black/blood/bone, тело ghostface/cj/steve/statham/lara (CJ из GTA SA, Стив из Minecraft, Стэтхэм, Лара Крофт 1996 (отдельная гранёная модель как в TR1, с рюкзаком и угловатой грудью) — гуманоиды со своей idle-анимацией; клавиша `B`). Всё в `VARIANTS`/`GESTURES` в `main.js`.
